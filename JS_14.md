...
class EngineVehicle extends Vehicle {
    constructor(name, wheels) {
        super(name, wheels);
        this.type = 'EngineVehicle';
    }
}

class WithoutEngineVehicle extends Vehicle {
    constructor(name, wheels) {
        super(name, wheels);
        this.type = 'WithoutEngineVehicle';
    }
}
...
class Tractor extends EngineVehicle {
    constructor(name, wheels) {
        super(name, wheels);
    }
}

class Bike extends WithoutEngineVehicle{
    constructor(name, wheels) {
        super(name, wheels);
    }
}
...
const vehicleFactory = {
    createVehicle(type) {
        switch (type.toLowerCase()) {
            ...
            case "tractor":
                return new Tractor('Tractor', 4);
            case "bike":
                return new Bike('Bike', 2);
            default:
                return null;
        }
    }
