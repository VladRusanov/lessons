...
1. Создать форму для регистрации. Должны быть поля - Email, Password, Name
...
Помним про переиспользуемые компоненты

2. Создать шарик

При нажатии на этот шарик он едет на 500 пикселей вправо

3. Перечитать теорию, написать пару своих любых компонентов (классовых и функций)
